...
#define CRI_VQ3ADX_ACF_NUM_CATEGORIES_PER_PLAYBACK (4)
#define CRI_VQ3ADX_ACF_CATEGORYNUM (1)
#define CRI_VQ3ADX_ACF_AISACCONTROLNUM (16)
#define CRI_VQ3ADX_ACF_GLOBALAISACNUM (0)
...
#define CRI_VQ3ADX_ACF_DSPSETTING_DSPBUSSETTING_0  "DspBusSetting_0" /*   */
