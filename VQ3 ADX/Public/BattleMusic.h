 ...
 *  File Size        : 8,210,464 bytes
 *  Date Time        : 2015/09/19 5:46
 *  Target           : Public
 *  Cues             : 4
 *  CueSheet Comment : 
 *===========================================================================*/
...
#define CRI_BATTLEMUSIC_BLOCK_BATTLEMUSIC_IGNIS4         (21) /* Ignis4  */
#define CRI_BATTLEMUSIC_BLOCK_BATTLEMUSIC_VOX            (22) /* Vox  */
#define CRI_BATTLEMUSIC_BLOCK_BATTLEMUSIC_VOX_2          (23) /* Vox_2  */
#define CRI_BATTLEMUSIC_BLOCK_BATTLEMUSIC_ENDRO          (24) /* endro  */
#define CRI_BATTLEMUSIC_BLOCK_BATTLEMUSIC_DEFENDHEAL     (25) /* DefendHeal  */
#define CRI_BATTLEMUSIC_BLOCK_BATTLEMUSIC_HEALDEFEND     (26) /* HealDefend  */
#define CRI_BATTLEMUSIC_BLOCK_BATTLEMUSIC_VOXMAGIC       (27) /* VoxMagic  */
#define CRI_BATTLEMUSIC_BLOCK_BATTLEMUSIC_WAIT           (28) /* wait  */
