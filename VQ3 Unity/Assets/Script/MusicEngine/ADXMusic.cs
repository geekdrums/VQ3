...
/// </summary>
public class ADXMusic : MonoBehaviour
{
	...
	private static ADXMusic Current;
	private static List<ADXMusic> MusicList = new List<ADXMusic>();
	...
	public static void Play( string MusicName, string firstBlockName = "" ) { MusicList.Find( ( ADXMusic m ) => m.name == MusicName ).PlayStart( firstBlockName ); }
	/// <summary>
