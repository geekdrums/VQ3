...
public class TitleUI : MonoBehaviour {
	...
	void Update () {
		...
		{
			ClickToStart.color = ColorManagerObsolete.MakeAlpha(Color.white, 0.7f + 0.3f * Music.MusicalCos());
			if( Input.GetMouseButtonDown(0) )
			{
				ClickToStart.AnimateColor(ColorManagerObsolete.MakeAlpha(Color.white, 0.0f), time: 0.1f);//AnimType.Linear
