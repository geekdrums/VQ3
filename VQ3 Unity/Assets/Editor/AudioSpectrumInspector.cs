...
public class AudioSpectrumInspector : Editor
{
    ...
    public override void OnInspectorGUI ()
    {
        ...
        spectrum.accentThreashold = EditorGUILayout.FloatField("AccentThreashold", spectrum.accentThreashold);
        spectrum.fftWindow = (FFTWindow)EditorGUILayout.EnumPopup("FFTWindow", spectrum.fftWindow);
