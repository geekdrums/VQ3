...
{
	/* スクリプトバージョン */
	private const string scriptVersionString = "2.05.05";
	private const int scriptVersionNumber = 0x02050500;
	...
	#if UNITY_EDITOR || UNITY_STANDALONE_OSX || UNITY_STANDALONE_WIN || UNITY_IPHONE || UNITY_ANDROID
		true;
	#else
		false;
	#endif
